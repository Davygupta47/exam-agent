    ...
    return (
      <div className="min-h-screen bg-page flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-ink-muted">Loading faculty portal...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {subjects.map((sub) => (
              <div
                key={sub.id}
                className="p-6 rounded-[22px] bg-surface border border-subtle shadow-xs hover:shadow-md hover:border-blue-300 dark:hover:border-blue-800 transition-all flex flex-col justify-between"
              >
                <div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-subtle mt-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2 rounded-full text-xs font-semibold bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white shadow-xs transition-all active:scale-95"
                  >
